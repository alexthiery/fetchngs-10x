    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${dashedLine(monochrome_logs)}
                ${colors.purple} __       __    __       _______. __          ___      .______ ${colors.reset}
                ${colors.purple}|  |     |  |  |  |     /       ||  |        /   \\     |   _  \\ ${colors.reset}
                ${colors.purple}|  |     |  |  |  |    |   (----`|  |       /  ^  \\    |  |_)  | ${colors.reset}
                ${colors.purple}|  |     |  |  |  |     \\   \\    |  |      /  /_\\  \\   |   _  < ${colors.reset}
                ${colors.purple}|  `----.|  `--'  | .----)   |   |  `----./  _____  \\  |  |_)  | ${colors.reset}
                ${colors.purple}|_______| \\______/  |_______/    |_______/__/     \\__\\ |______/ ${colors.reset}
            \n
